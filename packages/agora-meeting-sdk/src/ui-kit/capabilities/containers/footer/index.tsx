...
export const MettingFooter: FC<FooterProps> = observer(({}) => {
  ...
  const { memberVisible, setMemberVisible, language, goodsVisible, setGoodsVisible, } = useUIStore();
  ...
  const handleGoods = () => {
	  const curVisible = !goodsVisible;
	  setGoodsVisible(curVisible);
  };
